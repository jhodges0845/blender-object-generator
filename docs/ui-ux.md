...
2. **Create and component hierarchy** — group creation choices, advanced settings, reusable components, and continuation actions without changing their operators.
