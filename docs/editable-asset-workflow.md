...
6. [ ] Add preservation-aware animation Modify transport and the first narrowly scoped executable animation tuning semantics. First-class animation state is now exposed through inspection; executable operations are next.
